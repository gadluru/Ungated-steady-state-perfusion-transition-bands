...
%--------------------------------------------------------------------------
%   Inputs:      
%       - kSpace: radial SMS k-space data with CAIPI phase modulation [nx,nr,nc]
%           - nx: number of measurements along a ray
%           - nr: number of rays
%           - nc: number of PCA coils
%       - theta: radial k-space projection angle [1,nor]
%       - Nsms: number of simultaneous multi-slice [scalar]
%--------------------------------------------------------------------------
%   Outputs:
...
N = 60; % number of rays used to calibration
