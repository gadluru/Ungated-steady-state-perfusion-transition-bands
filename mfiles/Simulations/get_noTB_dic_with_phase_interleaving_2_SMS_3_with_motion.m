function SI = get_noTB_dic_with_phase_interleaving_2_SMS_3_with_motion(T1,flip_angle,TR,Nalpha,max_disp,heart_rate)
%--------------------------------------------------------------------------
...
%   steady-state (CRIMP) with no transition bands using a sinusoidal motion
%   model.
%--------------------------------------------------------------------------
%   Inputs:      
...
parfor i=1:length(T1)
    ...
    SI(:,:,i) = simu_noTB_with_phase_interleaving_2_SMS_3_with_motion(flip_angle_slice_excitation,slice_phase_excitation,Mz,M0,TR,Slab_T1,Nalpha,max_disp,heart_rate);
