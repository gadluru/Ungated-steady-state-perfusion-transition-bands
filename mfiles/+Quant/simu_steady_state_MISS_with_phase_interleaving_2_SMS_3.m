function [SI_one_slice,Mz] = simu_steady_state_MISS_with_phase_interleaving_2_SMS_3(flip_angle_slice_excitation,flip_angle_slice_transition,slice_phase_excitation,Mz,M0,TR,Slab_T1,Nalpha)
%--------------------------------------------------------------------------
%   [SI_one_slice,Mz] = simu_steady_state_MISS_with_phase_interleaving_2_SMS_3(flip_angle_slice_excitation,flip_angle_slice_transition,slice_phase_excitation,Mz,M0,TR,Slab_T1,Nalpha)
%--------------------------------------------------------------------------
%   This function models the Continuous Radial Interleaved
%   simultaneous Multi-slice acquisition at sPoiled steady-state (CRIMP)
%   with transition bands acquisition to generate a dictionary for
%   converting signal intensity to [Gd]
%--------------------------------------------------------------------------
%   Inputs:      
