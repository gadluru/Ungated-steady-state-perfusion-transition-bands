function [Image,para] = STCR_conjugate_gradient_nSMS_low_rank(Data,para)
%--------------------------------------------------------------------------
%   [Image,para] = STCR_conjugate_gradient_nSMS_low_rank(Data,para)
%--------------------------------------------------------------------------
%   STCR reconstruction with LRR regularization using conjugate gradient iterations to
...
weight_lr      = para.Recon.weight_lr;
...
low_rank = @(im) low_rank_yt_SMS(im,weight_lr,para);
...
%% fidelity term/temporal/spatial TV
    ...
    update_lr = low_rank(new_img_x);
    update_term = update_term + weight_lr * (update_lr - new_img_x);
